<?php
	...
	class NumberTheory {
		public function ExtendedEuclideanAlgorithmDifferences($args) {
			...
			$extended_euclidean_algorithm_differences_data_structure_args = [
			...
			for($i = $products_count - 2; $i > 0; $i--) {
				...
				if($extended_euclidean_algorithm_equation['firstquantity']['stage'] === 'multiple' && $extended_euclidean_algorithm_equation['secondquantity']['stage'] === 'multiple') {
					$euclidean_algorithm_differences_expansion_args = [
				...
				if($extended_euclidean_algorithm_equation['secondquantity']['stage'] === 'expanded') { // Second Quantity is Expanded, First Quantity Is Multiple
				...
				if($extended_euclidean_algorithm_equation['firstquantity']['stage'] === 'expanded') { // First Quantity is Expanded, Second Quantity Is Multiple
					$extended_euclidean_algorithm_equation['secondquantity']['value']['multiple'] += 
		...
		public function ExtendedEuclideanAlgorithmDifferencesLeftSideExpansion($args) {
			...
			$euclidean_algorithm_difference_args = [
			...
			$euclidean_algorithm_difference_args2 = [
			...
			$equation['firstquantity']['value']['rightexpansion'] = [
		...
		public function ExtendedEuclideanAlgorithmDifferencesRightSideExpansion($args) {
			...
			$equation['secondquantity']['value']['rightexpansion'] = [
		...
		public function DiocletianEquationEuclideanAlgorithmDifference($args) {
			...
			$extended_euclidean_algorithm_difference_results = [
		...
		public function ExtendedEuclideanAlgorithmProducts($args) {
			...
			if($first_number < $second_number) {
				list($first_number, $second_number) = [$second_number, $first_number];
			}
			
			$more_products = TRUE;
			while($more_products) {
				$extended_euclidean_algorithm_products_args = [
		...
		public function ExtendedEuclideanAlgorithmProduct($args) {
			...
			$extended_euclidean_algorithm_products_results = [
		...
		public function FindRelativelyPrimeNumbers($args) {
			...
			if(method_exists($this, $relatively_prime_number_order_function)) {
				$relatively_prime_number_order_function_args = [
					'number'=>$args['number'],

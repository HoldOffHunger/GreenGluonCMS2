<?php
	...
	class codeofconduct extends view {
		...
		public function getCodeOfConductParagraphs() {
			return [
				implode("\n\n", $this->getPrefaceSection(['headerindex'=>1])),
				implode("\n\n", $this->getIntroductionSection(['headerindex'=>2])),
				implode("\n\n", $this->getTableOfContentsSection(['headerindex'=>3])),
				implode("\n\n", $this->getWhatIsEncouragedSection(['headerindex'=>4])),
				implode("\n\n", $this->getWhatIsUnacceptableSection(['headerindex'=>5])),
				implode("\n\n", $this->getWhatIsUnaccountableSection(['headerindex'=>6])),
				implode("\n\n", $this->getHowWeEnforceCommunityStandardsSection(['headerindex'=>7])),
				implode("\n\n", $this->getLicensingSection(['headerindex'=>8])),
				implode("\n\n", $this->getInspirationSection(['headerindex'=>9])),
			];
		}

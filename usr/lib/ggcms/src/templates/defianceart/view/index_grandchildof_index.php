...
#	print('<div class="clear-float"></div>');
	...
	#	print_r($child);
		...
		if($child['childrecordstats'] && $child['childrecordstats'][0]) {
			$count = $child['childrecordstats'][0]['ChildRecordCount'];
			
			print('<div class="border-2px background-color-gray15 margin-5px float-right" style="font-family:arial; "><strong>');
			print($count);
			print(' Images</strong></div>');
		}

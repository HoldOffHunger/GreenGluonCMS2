$(document).ready(function() {
	...
	$('.brf-format-icon').tooltip({
		'content':getFormatToolTip({
			'imageurl':'https://www.revoltlib.com/image/formats/brf.jpg',
			'header':'BRF<br>Format',
		}),
		'track':true,
	});
	
	$('.brf2-format-icon').tooltip({
		'content':getFormatToolTip({
			'imageurl':'https://www.revoltlib.com/image/formats/brf2.jpg',
			'header':'BRF<br>Format',
		}),
		'track':true,
	});
